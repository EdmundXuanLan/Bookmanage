...
<div id="mainContainer">
   <strong><font size=5 color=red>修改失败，未改动或输入错误！<a href="/Bookmanage/BorrowAction/Borrow_modifyAction.action?borrowid=<%=session.getAttribute("borrowid") %>">点击返回</a></font></strong>
   <!--数据表格空白 -->
</div>
  </body>
</html>
