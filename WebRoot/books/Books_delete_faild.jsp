...
<html>
  <head>
    ...
    <title>My JSP 'Books_delete_faild.jsp' starting page</title>
...
<div id="mainContainer">
   <strong><font size=5 color=red>该书尚未归还或系统错误，删除失败！<a href="/Bookmanage/BooksAction/Books_queryAction.action">点击返回</a></font></strong>
   <!--数据表格空白 -->
</div>
  </body>
</html>
