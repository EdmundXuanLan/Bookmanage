...
var treeMenu = [
	{ level:1, name:"图书类型"},
	{ level:2, name:"图书列表", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:1, name:"最近看书"},
	{ level:2, name:"看书列表", ico:"images/icon_default.gif",link:"books/Books_query.action"},
	{ level:1, name:"信息管理"},
